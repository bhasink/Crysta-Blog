...
*/
 jQuery(document).ready(function($) {
    $('#customize-control-theme_options-layout_options_blog #foto-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_blog #foto-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('foto-blog-radio-img-selected') ;
        });
        $(this).addClass ('foto-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #foto-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_archive #foto-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('foto-blog-radio-img-selected') ;
        });
        $(this).addClass ('foto-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #foto-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_page #foto-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('foto-blog-radio-img-selected') ;
        });
        $(this).addClass ('foto-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #foto-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_single #foto-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('foto-blog-radio-img-selected') ;
        });
        $(this).addClass ('foto-blog-radio-img-selected') ;
    });   

    $('#customize-control-theme_options-layout_options_boxed #foto-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_boxed #foto-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('foto-blog-radio-img-selected') ;
        });
        $(this).addClass ('foto-blog-radio-img-selected') ;
    });                    
