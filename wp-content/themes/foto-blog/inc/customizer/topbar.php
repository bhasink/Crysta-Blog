...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Contact Info', 'foto-blog' ),
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Social Links', 'foto-blog' ),
        'panel'    => 'header_top_panel',
        'priority' => 20,
    )
);
...
$wp_customize->add_control(
    'theme_options[show_header_social_links]',
    array(
        'label'       => __( 'Show Social Links', 'foto-blog' ),
...
$wp_customize->add_control(
    'theme_options[social_link_1]',
    array(
        'label'           => __( 'Social Link 1', 'foto-blog' ),
        'description'     => __( 'Enter valid url.', 'foto-blog' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'foto_blog_social_links_active',
    )
);
...
$wp_customize->add_control(
    'theme_options[social_link_2]',
    array(
        'label'           => __( 'Social Link 2', 'foto-blog' ),
        'description'     => __( 'Enter valid url.', 'foto-blog' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'foto_blog_social_links_active',
...
$wp_customize->add_control(
    'theme_options[social_link_3]',
    array(
        'label'           => __( 'Social Link 3', 'foto-blog' ),
        'description'     => __( 'Enter valid url.', 'foto-blog' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'foto_blog_social_links_active',
