...
$wp_customize->add_section( 'section_featured_slider',
	array(
		'title'      => __( 'Featured Slider', 'foto-blog' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_featured_slider]', 
	array(		
	'label' 	=> __('Disable Slider Section', 'foto-blog'),
...
$wp_customize->add_control('theme_options[number_of_sr_items]', 
	array(
	'label'       => __('Number Of Slides', 'foto-blog'),
	...
	'type'        => 'number',
	'active_callback' => 'foto_blog_slider_active',
	'input_attrs' => array(
			'min'	=> 1,
			'max'	=> 3,
			'step'	=> 1,
...
$wp_customize->add_control('theme_options[featured_slider_speed]', 
	array(
	'label'       => __('Slider Speed', 'foto-blog'),
	'description' => esc_html__( 'Select Value Between 0 to 8000. Default is 1500.', 'foto-blog' ),
	'section'     => 'section_featured_slider',   
...
$wp_customize->add_control('theme_options[sr_content_type]', 
	...
	'active_callback' => 'foto_blog_slider_active',
	'choices'	  => array(
			'sr_page'	  => __('Page','foto-blog'),
			'sr_post'	  => __('Post','foto-blog'),
		),
	)
);
...
for( $i=1; $i<=$number_of_sr_items; $i++ ){
	...
	$wp_customize->add_control('theme_options[slider_page_'.$i.']', 
		...
		'type'        => 'dropdown-pages',
		'active_callback' => 'foto_blog_slider_page',
		)
	);
	...
	$wp_customize->add_control('theme_options[slider_post_'.$i.']', 
		...
		'active_callback' => 'foto_blog_slider_post',
		)
	);
}
