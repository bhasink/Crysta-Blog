<?php
/**
 * Fascinate Theme Info Configurations
 *
...
if( ! function_exists( 'themebeez_toolkit_fascinate_config'  ) ) {
	...
	function themebeez_toolkit_fascinate_config() {
		...
		$config = array(
			...
			'welcome_title' => sprintf( esc_html__( 'Welcome to %s - ', 'themebeez-toolkit' ), 'Fascinate' ),
			...
			'quick_links' => array(
				...
				'theme_url' => array(
					...
					'url'  => 'https://themebeez.com/themes/fascinate/',
					),
				'demo_url' => array(
					'text' => esc_html__( 'View Demo','themebeez-toolkit' ),
					'url'  => 'https://themebeez.com/demos/?theme=fascinate',
					),
				'documentation_url' => array(
					'text'   => esc_html__( 'View Documentation','themebeez-toolkit' ),
					'url'    => 'https://themebeez.com/docs/fascinate-theme-documentation/',
					),
				'pro_url' => array(
			...
			'getting_started' => array(
				...
				array(
					...
					'button_link'         => 'https://themebeez.com/docs/fascinate-theme-documentation/',
					'is_button'           => true,
					'recommended_actions' => false,
					'is_new_tab'          => true,
				),				
				...
				array(
					...
					'button_link'  			=> 'https://themebeez.com/themes/fascinate-pro/',
					'is_button'    			=> true,
					'recommended_actions' 	=> false,
					'is_new_tab'   			=> true,
				),
